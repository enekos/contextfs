...
export const config = {
  ...
  get centralContextServerUrl() { return process.env.CENTRAL_CONTEXT_SERVER_URL || ""; },
  get centralContextServerToken() { return process.env.CENTRAL_CONTEXT_SERVER_TOKEN || ""; },
