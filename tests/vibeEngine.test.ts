...
describe("vibeEngine", () => {
  ...
  describe("planVibeSearch", () => {
    it("throws if GEMINI_API_KEY is not set", async () => {
      ...
      const { planVibeSearch } = await import("../mairu/contextfs/src/llm/vibeEngine");
  ...
  describe("executeVibeQuery", () => {
    it("runs search queries against the correct stores", async () => {
      ...
      const { executeVibeQuery } = await import("../mairu/contextfs/src/llm/vibeEngine");
  ...
  describe("planVibeMutation", () => {
    it("throws if GEMINI_API_KEY is not set", async () => {
      delete process.env.GEMINI_API_KEY;
      const { planVibeMutation } = await import("../mairu/contextfs/src/llm/vibeEngine");
  ...
  describe("executeMutationOp", () => {
    it("forwards AI metadata fields on create_memory", async () => {
      ...
      const { executeMutationOp } = await import("../mairu/contextfs/src/llm/vibeEngine");
